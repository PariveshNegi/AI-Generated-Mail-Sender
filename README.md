...
### Structure
- Create the /client folder and put the index.html , script.js and style.css files in it.
- Create the /server folder and put the .env , index.js , package.json files in it.
---
## 🚀 Setup
